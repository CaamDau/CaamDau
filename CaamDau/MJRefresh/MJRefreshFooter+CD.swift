...
public extension CaamDau where Base: MJRefreshFooter {
    /// 忽略多少scrollView的contentInset的bottom
    @discardableResult
    func ignoredContentInsetBottom(_ t:CGFloat = 0) -> CaamDau {
...
//MARK:--- MJRefreshAutoFooter 重设置 ----------
public extension CaamDau where Base: MJRefreshAutoFooter {
    /// 是否自动刷新
    @discardableResult
    func isAutoRefresh(_ t:Bool = true) -> CaamDau {
        base.isAutomaticallyRefresh = t
        return self
    }
    /// 当底部控件出现多少时就自动刷新
    @discardableResult
    func autoRefreshPercent(_ t:CGFloat = 1.0) -> CaamDau {
        base.triggerAutomaticallyRefreshPercent = t
        return self
    }
    /// 是否每一次拖拽只发一次请求
    @discardableResult
    func onlyRefreshPerDrag(_ t:Bool = false) -> CaamDau {
        base.isOnlyRefreshPerDrag = t
        return self
    }
}
//MARK:--- MJRefreshBackNormalFooter 重设置 ----------
public extension CaamDau where Base: MJRefreshBackNormalFooter {
...
public extension CaamDau where Base: MJRefreshAutoNormalFooter {
    var activityStyle:UIActivityIndicatorView.Style {
        set{
            base.activityIndicatorViewStyle = newValue
        }
...
public extension CaamDau where Base: MJRefreshBackStateFooter {
    /// 设置文字
    @discardableResult
...
public extension CaamDau where Base: MJRefreshAutoStateFooter {
    /// 设置文字
    @discardableResult
    func setTitle(isHidden:Bool = true,
                  font:UIFont = UIFont.systemFont(ofSize: 14),
